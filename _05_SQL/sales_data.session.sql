...
ALTER TABLE dim_products 
    RENAME COLUMN IF NOT EXISTS product_price TO "product_price_(gbp)",  -- Step 2: Rename 'product_price' to 'product_price_(gbp)''
...
-- Task 5
ALTER TABLE dim_products
    RENAME COLUMN IF NOT EXISTS removed TO still_available,  -- Step 1: Rename 'removed' to 'still_available'
    ALTER COLUMN "product_price_(gbp)" TYPE FLOAT USING ("product_price_(gbp)"::FLOAT),  -- Step 2: Change data types of columns
